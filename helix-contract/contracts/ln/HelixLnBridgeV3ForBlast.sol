...
contract HelixLnBridgeV3ForBlast is Initializable, LnBridgeSourceV3, LnBridgeTargetV3 {
    ...
    function initialize(address _dao, address _blast, address _blastPoints) public initializer {
        _initialize(_dao);
